...
public class CustomersMapActivity extends FragmentActivity implements OnMapReadyCallback,
        ...
        CallCabCarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if (requestType)
                {
                    ...
                    CallCabCarButton.setText("Call an Artisan");
                ...
                else
                {
                    ...
                    CallCabCarButton.setText("Getting your Artisan...");
                    getClosetDriverCab();
                }
            }
        });
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location)
            {
                ...
                if(!driverFound && requestType)
                {
                    ...
                    CallCabCarButton.setText("Looking for Artisan  Location...");
                }
            }
    ...
    {
        Intent startPageIntent = new Intent(CustomersMapActivity.this, Home.class);
