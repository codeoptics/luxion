...
//        };
        ...
        DriverWelcomeButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent DriverIntent = new Intent(Home.this, DriverLoginRegisterActivity.class);
        ...
        CustomerWelcomeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Intent CustomerIntent = new Intent(Home.this, CustomerLoginRegisterActivity.class);
